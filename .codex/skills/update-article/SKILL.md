...
1. Read:
   - `llm_docs/skills/update-article.md`
   - `llm_docs/guidelines-content/*`
2. Perform deep research before updating.
3. Ensure code blocks use `collapse={...}` and specs are cited.
