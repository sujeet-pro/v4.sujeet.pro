# Web App Security Architecture: Headers, CSP, Auth, Crypto

A practical guide to security architecture choices, defense-in-depth controls, and implementation details for modern web applications.

## TLDR

- **Rendering strategy affects attack surface**: SSR, SSG, and CSR require different defenses.
- **Security headers and CSP** provide strong mitigation against XSS, clickjacking, and data exfiltration.
- **Auth, crypto, and input validation** are the foundation for protecting user data and system integrity.
- **Defense in depth** combines preventive, detective, and corrective controls.
...
> **Note:** Always use `createCipheriv` with authenticated encryption modes like GCM. The deprecated `createCipher` used deterministic IV derivation which is insecure for counter modes.
...
```javascript collapse={1-11, 57-63}
const express = require("express")
const helmet = require("helmet")
const rateLimit = require("express-rate-limit")
...
- Essential security headers (CSP, HSTS, X-Frame-Options)
...
- Content Security Policy with nonce-based validation
...
- [OWASP Top 10:2021](https://owasp.org/Top10/) - Official OWASP Top 10 web application security risks
- [OWASP Cheat Sheet Series](https://cheatsheetseries.owasp.org/) - Practical security guidance for developers
- [MDN Web Security](https://developer.mozilla.org/en-US/docs/Web/Security) - Mozilla's comprehensive web security documentation
- [Content Security Policy (CSP) - MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP) - Official CSP documentation and implementation guide
- [Node.js Crypto Documentation](https://nodejs.org/api/crypto.html) - Official Node.js cryptography module documentation
- [RFC 6749 - OAuth 2.0](https://datatracker.ietf.org/doc/html/rfc6749) - OAuth 2.0 Authorization Framework specification
- [RFC 7519 - JSON Web Tokens](https://datatracker.ietf.org/doc/html/rfc7519) - JWT specification
- [Web Authentication API (WebAuthn) - W3C](https://www.w3.org/TR/webauthn-2/) - W3C WebAuthn specification
- [Helmet.js Documentation](https://helmetjs.github.io/) - Express.js security middleware
...
- [Security Headers](https://securityheaders.com/) - Security header analysis tool
- [Mozilla Observatory](https://observatory.mozilla.org/) - Web security analysis tool
- [SSL Labs Server Test](https://www.ssllabs.com/ssltest/) - SSL/TLS configuration testing
