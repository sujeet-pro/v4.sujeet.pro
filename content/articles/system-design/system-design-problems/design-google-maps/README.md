# Draft: Design Google Maps

Building a mapping and navigation platform.

## TLDR

- Tile-based rendering enables efficient map display
- Traffic-aware routing provides accurate ETAs
- Offline maps require careful tile management
...
7. Updates: map data freshness, user contributions
