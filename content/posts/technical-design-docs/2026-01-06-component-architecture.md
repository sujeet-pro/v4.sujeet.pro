...
export const homeRegistry: WidgetRegistry = {
  HERO_BANNER: {
    component: lazy(() =>
      import('@widgets/hero-banner').then(m => ({ default: m.HeroBannerWidget }))
    ),
  ...
  PRODUCT_CAROUSEL: {
    component: lazy(() =>
      import('@widgets/product-carousel').then(m => ({ default: m.ProductCarouselWidget }))
    ),
    withErrorBoundary: true,
    withSuspense: true,
  },
  ...
  CATEGORY_GRID: {
    component: lazy(() =>
      import('@widgets/category-grid').then(m => ({ default: m.CategoryGridWidget }))
    ),
  },

  PROMOTIONAL_BANNER: {
    component: lazy(() =>
      import('@widgets/promotional-banner').then(m => ({ default: m.PromotionalBannerWidget }))
    ),
  },

  NEWSLETTER_SIGNUP: {
    component: lazy(() =>
      import('@widgets/newsletter-signup').then(m => ({ default: m.NewsletterSignupWidget }))
    ),
