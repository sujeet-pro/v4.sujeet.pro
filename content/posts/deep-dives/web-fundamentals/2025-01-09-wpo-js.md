...
> Part of the [Web Performance Optimization series](/posts/deep-dives/web-fundamentals/wpo-overview/). See also: [Infrastructure](/posts/deep-dives/web-fundamentals/wpo-infrastructure/), [CSS & Typography](/posts/deep-dives/web-fundamentals/wpo-css-typography/), [Images](/posts/deep-dives/web-fundamentals/wpo-images/).
...
- [scheduler.yield() Proposal](https://github.com/nickolaslippolis/isInputPending) - Task scheduling API
...
- [Performance Observer API](https://developer.mozilla.org/en-US/docs/Web/API/PerformanceObserver) - Performance monitoring
- [Long Tasks API](https://w3c.github.io/longtasks/) - Detecting long-running tasks
